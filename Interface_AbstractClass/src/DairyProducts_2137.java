...
public class DairyProducts_2137 extends Urun_2137 {
    ...
    public DairyProducts_2137(String adi, int kategoriIndex, String birimAgirligi, Double birimFiyati,
    ...
    public void YeniUrunEkle(String Adi, int KategoriIndex, String BirimAgirligi, Double BirimFiyati,
        ...
        DairyProducts_2137 uruny = new DairyProducts_2137(Adi, KategoriIndex, BirimAgirligi, BirimFiyati,
                KategoriDetay, Detay);
        urun4.add(uruny);
