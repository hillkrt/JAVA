...
public class Beverages_2137 extends Urun_2137 {
    ...
    public Beverages_2137(String adi, int kategoriIndex, String birimAgirligi, Double birimFiyati,
    ...
    @Override
    public void UrunKategorikZamYap(int X, ArrayList<Beverages_2137> urun1, ArrayList<Condiments_2137> urun2,
    ...
    public void YeniUrunEkle(String Adi, int KategoriIndex, String BirimAgirligi, Double BirimFiyati,
        ...
        Beverages_2137 uruny = new Beverages_2137(Adi, KategoriIndex, BirimAgirligi, BirimFiyati,
                KategoriDetay, Detay);
        urun1.add(uruny);
